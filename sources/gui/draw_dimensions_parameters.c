...
/*   Updated: 2017/03/03 22:15:38 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_dimensions_parameter(t_rt *rt, t_obj *o)
{
	...
	{
		draw_parameter(rt, ft_dtoa(o->lenght), rt->ui->obj_b_rect[6], 2);
		draw_parameter(rt, ft_dtoa(o->width), rt->ui->obj_b_rect[7], 2);
	}
	else
	{
	...
	o->forme == T_CONE || o->forme == T_TORUS)
		draw_parameter(rt, ft_dtoa(o->height), rt->ui->obj_b_rect[8], 2);
	else
