...
/*   Updated: 2017/03/01 19:53:14 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_selected_object(t_rt *rt, t_obj *obj)
{
	...
	tmp = ft_strf("SPECULAR");
	draw_parameter(rt, tmp, rt->ui->obj_b_rect[2], 2);
	draw_parameter(rt, ft_dtoa(obj->reflex), rt->ui->obj_b_rect[3], 2);
	draw_parameter(rt, ft_dtoa(obj->refract), rt->ui->obj_b_rect[4], 2);
