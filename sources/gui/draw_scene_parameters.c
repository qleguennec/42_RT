...
/*   Updated: 2017/02/23 19:29:59 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

static void	draw_parameter_static(t_rt *rt, char *tmp, int y)
{
...
void		draw_scene_parameters(t_rt *rt)
{
	...
	draw_parameter_static(rt, tmp, (rt->ui->area[3].y + 2));
	tmp = ft_itoa(rt->scn->aa);
	draw_parameter_static(rt, tmp, (rt->ui->area[3].y + 29));
	tmp = ft_itoa(rt->scn->m_ref);
	draw_parameter_static(rt, tmp, (rt->ui->area[3].y + 56));
}
