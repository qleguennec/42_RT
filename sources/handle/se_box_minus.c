...
/*   Updated: 2017/03/03 19:46:15 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_se_camera_box(t_rt *rt)
{
	...
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->rot.x >= 0.5)
		rt->scn->s_elem->rot.x -= 0.50;
	else if (rt->ui->case_active == 6 && rt->scn->s_elem->rot.y >= 0.5)
		rt->scn->s_elem->rot.y -= 0.50;
	else if (rt->ui->case_active == 7 && rt->scn->s_elem->rot.z >= 0.5)
...
static void	update_se_light_box(t_rt *rt)
{
	if (rt->ui->case_active == 1 && rt->scn->s_elem->intensity > 0)
	...
	else if (rt->ui->case_active == 3 && rt->scn->s_elem->clr.x >= 0.002)
		rt->scn->s_elem->clr.x -= 0.0020;
	else if (rt->ui->case_active == 4 && rt->scn->s_elem->clr.y >= 0.002)
		rt->scn->s_elem->clr.y -= 0.0020;
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->clr.z >= 0.002)
		...
		rt->scn->s_elem->pos.z -= 0.50;
	else if (rt->ui->case_active == 9 && rt->scn->s_elem->rot.x >= 0.5)
		rt->scn->s_elem->rot.x -= 0.50;
	else if (rt->ui->case_active == 10 && rt->scn->s_elem->rot.y >= 0.5)
		rt->scn->s_elem->rot.y -= 0.50;
	else if (rt->ui->case_active == 11 && rt->scn->s_elem->rot.z >= 0.5)
		rt->scn->s_elem->rot.z -= 0.50;
	redraw_case_active(rt, 1);
}
...
{
	if (rt->ui->case_active == 3 && rt->scn->s_elem->reflex >= 0.050)
		rt->scn->s_elem->reflex -= 0.050;
	else if (rt->ui->case_active == 4 && rt->scn->s_elem->refrac_y >= 0.050)
		rt->scn->s_elem->refrac_y -= 0.050;
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->radius >= 1.0)
		rt->scn->s_elem->radius -= 1.00;
	else if (rt->ui->case_active == 6 && rt->scn->s_elem->radius >= 0.50)
		rt->scn->s_elem->radius -= 0.50;
	else if (rt->ui->case_active == 7 && rt->scn->s_elem->radius >= 0.50)
		rt->scn->s_elem->radius -= 0.50;
	else if (rt->scn->s_elem->radius >= 0.50)
		rt->scn->s_elem->radius -= 0.50;
}
...
static void	update_se_object_box(t_rt *rt)
{
	if (rt->ui->case_active == 1 && rt->scn->s_elem->opacity >= 0.05)
		...
		rt->scn->s_elem->clr.y -= 0.0020;
	else if (rt->ui->case_active == 11 && rt->scn->s_elem->clr.z >= 0.002)
		rt->scn->s_elem->clr.z -= 0.0020;
		...
		rt->scn->s_elem->pos.z -= 0.50;
	else if (rt->ui->case_active == 15 && rt->scn->s_elem->rot.x >= 0.5)
		rt->scn->s_elem->rot.x -= 0.50;
	else if (rt->ui->case_active == 16 && rt->scn->s_elem->rot.y >= 0.5)
		rt->scn->s_elem->rot.y -= 0.50;
	else if (rt->ui->case_active == 17 && rt->scn->s_elem->rot.z >= 0.5)
		rt->scn->s_elem->rot.z -= 0.50;
	redraw_case_active(rt, 1);
}
