...
/*   Updated: 2017/04/28 19:35:43 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_se_camera_box(t_rt *rt)
{
	...
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->rot.x <= 999.50f)
...
static void	update_se_light_box(t_rt *rt)
{
	...
	else if (rt->ui->case_active == 3 && rt->scn->s_elem->clr.x <= 0.9980f)
		rt->scn->s_elem->clr.x += 0.0020f;
	else if (rt->ui->case_active == 4 && rt->scn->s_elem->clr.y <= 0.9980f)
		rt->scn->s_elem->clr.y += 0.0020f;
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->clr.z <= 0.9980f)
...
{
	if (rt->ui->case_active == 3 && rt->scn->s_elem->reflex <= 0.950f)
		rt->scn->s_elem->reflex += 0.050f;
	else if (rt->ui->case_active == 4 && rt->scn->s_elem->refrac_y <= 0.950f)
		rt->scn->s_elem->refrac_y += 0.050f;
	else if (rt->ui->case_active == 5 && rt->scn->s_elem->radius <= 499.0f)
		rt->scn->s_elem->radius += 1.0f;
	else if (rt->ui->case_active == 6 && rt->scn->s_elem->width <= 999.50f)
		rt->scn->s_elem->width += 0.50;
	else if (rt->ui->case_active == 7 && rt->scn->s_elem->height <= 999.50f)
		rt->scn->s_elem->height += 0.50;
	else if (rt->scn->s_elem->lenght <= 999.50f)
		rt->scn->s_elem->lenght += 0.50;
}

static void	update_se_object_box(t_rt *rt)
{
	if (rt->ui->case_active == 1 && rt->scn->s_elem->opacity <= 0.950f)
	{
		rt->scn->s_elem->opacity += 0.050f;
		rt->scn->s_elem->opacity = roundf(rt->scn->s_elem->opacity * 100) / 100;
	}
	else if (rt->ui->case_active == 2 && rt->scn->s_elem->specular <= 0.950f)
		rt->scn->s_elem->specular += 0.050f;
	else if (rt->ui->case_active > 2 && rt->ui->case_active < 9)
		update_se_object_box_part2(rt);
	else if (rt->ui->case_active == 9 && rt->scn->s_elem->clr.x <= 0.9980f)
		rt->scn->s_elem->clr.x += 0.0020f;
	else if (rt->ui->case_active == 10 && rt->scn->s_elem->clr.y <= 0.9980f)
		rt->scn->s_elem->clr.y += 0.0020f;
	else if (rt->ui->case_active == 11 && rt->scn->s_elem->clr.z <= 0.9980f)
		rt->scn->s_elem->clr.z += 0.0020f;
