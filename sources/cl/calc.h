...
/*   Updated: 2017/03/01 21:44:20 by bsouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float3			touch_object(global t_obj *tab_objs, short nobjs, float3 ray_pos,
                float3 ray_dir, short *id);
float3			ray_plane_intersection(global t_obj *obj, float3 ray_pos,
                float3 ray_dir, short *ok);
float3			ray_cone_intersection(global t_obj *obj, float3 ray_pos,
                float3 ray_dir, short *ok);
