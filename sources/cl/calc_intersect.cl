...
/*
	...
	if (data->obj->height > 0.0f && (sqrt(dot(data->intersect - data->obj->pos,
					data->intersect - data->obj->pos)) > sqrt((test * data->obj->height) *
					 (test * data->obj->height) + data->obj->radius  * data->obj->radius) ||
			dot(data->intersect, data->obj->pos) < 0.0f))
		return (0);
*/
	return (1);
}
